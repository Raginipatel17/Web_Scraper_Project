...
mongoose.connect('mongodb+srv://Sydney_scraper:Ragini5122@scraperdatabase.lgcp3vk.mongodb.net/?appName=scraperDatabase').then(()=>{console.log('database connnected'); await scrape();}).catch((e)=>{console.log(e)});
